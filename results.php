...
$page_title = ($row ? ('Analysis Results: ' . $row['analysis_name']) : 'No Analysis Results') . ' | NanoAnalyzer';
    ...
    <div class="container-fluid p-4">
      ...
      <?php else: ?>
        ...
        <div class="glass-panel p-5 text-center my-4">
          <div class="mb-3">
            <i class="bi bi-file-earmark-medical text-cyan" style="font-size: 3.5rem;"></i>
          </div>
          <h3 class="text-white fw-bold mb-2">No Analysis Results</h3>
          <p class="text-muted mb-4 fs-6">No analysis has been performed yet. Start a new analysis to view your results.</p>
          <a href="predict.php" class="btn btn-glass"><i class="bi bi-arrow-repeat me-1"></i> New Run</a>
        </div>
      <?php endif; ?>
    </div>
